...
export default function Dashboard() {
  ...
  // Filter brands for suggestions and table
  ...
  const filteredBrands = selected
    ? brands.filter(brand => brand.id === selected.id)
    : search
    ? suggestions
    : brands;
            ...
            <div className="flex items-end gap-2 mt-2 relative">
              ...
              <Link href="/brands/create">
                ...
                >
                  ...
                  <span className="max-sm:sr-only">Add new Brand</span>
                </Button>
              </Link>
                    ...
                    <TableRow key={brand.id}>
                      ...
                      <TableCell>
                        <div className="relative">
                          <Button
                            ref={el => { buttonRefs.current[brand.id] = el; }}
                            size="icon"
                            variant="ghost"
                            onClick={e => {
                              e.stopPropagation();
                              handleMenuToggle(brand.id);
                            }}
                            aria-label="Actions"
                          >
                            <MoreVertical />
                          </Button>
                          {openMenuId === brand.id && menuPosition && (
                            <div
                              ref={menuDropdownRef}
